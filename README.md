...
- Run the IBX walkshed estimator (0.5 mile each side of `data/stations_ibx.geojson`):
  `uv run python -m nyt_ibx_lvt.pipeline --pluto data/nyc_mappluto_25v3_fgdb/MapPLUTO25v3.gdb --bbl-field BBL --values data/property_values.parquet --stations data/stations_ibx.geojson --out-geojson data/ibx_walkshed.geojson --map-html data/ibx_walkshed.html`
...
- Stations: `data/stations_ibx.geojson`
